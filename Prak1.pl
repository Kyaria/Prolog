...
% fridolin(L1), susi(L2), numberOfMatches(L1, L2, N), endCount(L1, G1), endCount(L2, G2), G1 == G2, N == G1.


% No. 1, c/ Baumstrukturen
defTree(string, n("HALLO", n("Bonjourno", nil, n("Penis", nil, nil)), n("Dickbutt", nil, nil))).
defTree(integer, n(42, n(69, nil, n(420, nil, nil)), n(666, nil, nil))).
defTree(stringFUCK, n("Dickbutt", n("Dickbutt", nil, n("Dickbutt", nil, nil)), n("Dickbutt", nil, nil))).

tree(nil).                              % Leerer Baum.
tree(n(X, L, R)) :- tree(L), tree(R).   % Node mit Element, linkem und rechtem Baum.
